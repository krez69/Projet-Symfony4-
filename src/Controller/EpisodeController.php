...
class EpisodeController extends AbstractController
{
     ...
     * @return Response
     */
    public function show(Episode $episode, Request $request, ObjectManager $manager): Response
    {
        $comment = new Comment();
    ...
    public function edit(Request $request, Episode $episode, Slugify $slugify): Response
    {
        ...
        //Verification si l'utilisateur à bien validé les champs du formulaire
        if ($form->isSubmitted() && $form->isValid()) {
